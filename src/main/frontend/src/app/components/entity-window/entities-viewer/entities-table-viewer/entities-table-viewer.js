...
export default class EntitiesTableViewer extends Component {
  ...
  onExportClick() {
    ...
    ApiCall.post(`${apiURLBasename.substr(1)}/export-excel`, null, null, {entityName: this.props.entityId, ids: Object.keys(this.state.selectedIds).join(','), locale: locale}).then(result => {
