...
export default class EntitySection extends Component {
  ...
  getSectionItemRenderer(item, index) {
    ...
    switch (item.xtype) {
      ...
      case nemesisFieldTypes.nemesisCollectionField: console.log(item); elementConfig.onEntityItemClick= this.props.onEntityItemClick; elementConfig.entityId = item.entityId; elementConfig.value = elementConfig.value || []; reactElement = NemesisEntityCollectionField; break;
