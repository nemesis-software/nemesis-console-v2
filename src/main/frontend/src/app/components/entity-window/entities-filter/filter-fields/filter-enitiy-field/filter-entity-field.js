  ...
  render() {
    return (
      <div>
        ...
        <NemesisEntityField name={this.props.filterItem.entityId} style={this.getTextFieldStyles()} onValueChange={this.onSelectedMenuItem.bind(this)} label={this.props.filterItem.fieldLabel}/>
      </div>
    )
  }
