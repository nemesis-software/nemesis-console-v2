      ...
      <div style={{width: '100%'}} className="display-table">
        <div className="display-table-row">
          <div className="display-table-cell">
            ...
            <ProgressBar variant="success" now={this.getMemoryPercents(this.props.data['mem.free'], this.props.data['mem'])} label={this.getMemoryPercents(this.props.data['mem.free'], this.props.data['mem']) + '%'} />
          </div>
        </div>
        ...
        <div className="display-table-row">
          <div className="display-table-cell">
            ...
            <ProgressBar variant="success" now={this.getMemoryPercents(this.props.data['heap'] - this.props.data['heap.used'], this.props.data['heap'])} label={this.getMemoryPercents(this.props.data['heap'] - this.props.data['heap.used'], this.props.data['heap']) + '%'} />
          </div>
        </div>
